            ...
            <form role="form" enctype="multipart/form-data" action="../../App/Database/insertcliente.php" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="estado_civil" class="form-control" id="exampleInputEmail1" placeholder="estado_civil" value="' . $resp['cliente']['estado_civil'] . '">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="data_nascimento" class="form-control" id="exampleInputEmail1" placeholder="data_nascimento" value="' . $resp['cliente']['data_nascimento'] . '">
                </div>
                <div class="form-group">
                ...
                <input type="hidden" name="idCliente" value="' . $resp['cliente']['idCliente'] . '">

              <!-- /.box-body -->

              <div class="box-footer">
                <button type="submit" name="upload" class="btn btn-primary" value="Cadastrar">Atualizar</button>
