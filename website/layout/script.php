...
*/
$url = 'http://localhost/projetos/website/views/'; // Remova em caso de utilizar o código para hospedagem web 
...
<head>
  ...
  <title>Secretaria Desenvolvimento Rural | Dashboard</title>
...
$header = '<header class="main-header">
    ...
    <a href="' . $url . '" class="logo">
      ...
      <span class="logo-lg"><b>ADMIN </b>RURAL</span>
    </a>
...
<!-- Equipamentos -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="' . $url . 'cliente/list"><i class="fa fa-circle-o"></i>Listar</a></li>
...
$footer = '<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023-2024 <a href="http://almsaeedstudio.com">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
